...
![Screenshot of request details in the debugbar](/assets/screenshots/request.png)

The headers are collapsed for clarity, but you can expand them.

![Screenshot of request headers in the debugbar](/assets/screenshots/request-headers.png)
