...
export function Hero() {
  return (
    <div className="overflow-hidden bg-stone-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-red-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                <div className="absolute -top-px left-20 right-11 h-px bg-gradient-to-r from-red-300/0 via-red-300/70 to-red-300/0" />
                ...
                <div className="pl-4 pt-4">
                  ...
                  <div className="mt-6 flex items-start px-1 text-sm">
                    <div
                      aria-hidden="true"
                      className="select-none border-r border-stone-300/5 pr-4 font-mono text-stone-600"
                    >
                      {Array.from({
                        length: code.split('\n').length,
                      }).map((_, index) => (
