...
export function Prose<T extends React.ElementType = 'div'>({
  ...
  return (
    <Component
      className={clsx(
        className,
        'prose prose-stone max-w-none dark:prose-invert dark:text-stone-400',
        // headings
