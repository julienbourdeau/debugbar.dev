...
const variantStyles = {
  primary:
    'rounded-full bg-red-300 py-2 px-4 text-sm font-semibold text-stone-900 hover:bg-red-200 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-300/50 active:bg-red-500',
  secondary:
